...
describe('clippings.txt test run', () => {
  ...
  test('all posted Notes get added to DB', async () => {
    ...
    // console.log('before: ', bookNotesAtStart)
    // console.log('after: ', bookNotesAfterPost)
    // console.log('before length: ', bookNotesAtStart.length)
    // console.log('after length: ', bookNotesAfterPost.length)
